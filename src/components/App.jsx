...
function App() {
  ...
  const { status: itemStatus, data: itemCollection } =
  ...
  const { status: typeStatus, data: typeCollection } =
    useFirestoreCollectionData(
  ...
  const lifestyleCollectionRef = user?.uid
    ? collection(firestore, 'user', user.uid, 'lifestyle')
    : null;
  const lifestyleQuery = lifestyleCollectionRef
    ? query(lifestyleCollectionRef, orderBy('name'))
    : null;

  const { status: lifestyleStatus, data: lifestyleCollection } =
    useFirestoreCollectionData(
